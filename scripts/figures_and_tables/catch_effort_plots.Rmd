...
This script contains the functions to create catch-efoort plot used in our peoject.
...
qr_effort_catch_plot(gear = "trawlers")

qr_effort_catch_plot(gear = "seiners")

qr_effort_catch_plot(gear = "drifting_longlines")
